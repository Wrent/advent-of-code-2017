...
//		System.out.println(duet.getFirstRecoveredFrequency(duetInput));
		...
		final String packetMazeInput = "                                                                                                             |                                                                                           \n" +
				...
				"           +-------------------------------------------------------+       +---------------------------------+                     +-------------------------------------------------------+             \n" +
				"                                                                                                                                                                                                         ";
		final PacketMaze packetMaze = new PacketMaze(packetMazeInput);
		System.out.println("Packet maze result is:");
		System.out.println(packetMaze.getLetters());
		System.out.println("Steps count:");
		System.out.println(packetMaze.countSteps());

		final String particlesInput = "p=<-1027,-979,-188>, v=<7,60,66>, a=<9,1,-7>\n" +
...
//		particlesWithCollisions.doIterationsWithCollisions(10000);
		...
		final String computerArtInput = "../.. => .../.##/##.\n" +
				...
				"###/#.#/### => #.#./####/.##./.##.\n" +
				"###/###/### => .#.#/..##/#.##/.##.";
		ComputerArt computerArt = new ComputerArt();
		System.out.println("Computer art result is:");
...
//		System.out.println(coprocessor.getNumberOfMultiplies(coprocessorInput));
		...
		final String bridgeInput = "31/13\n" +
				"34/4\n" +
				"49/49\n" +
				"23/37\n" +
				"47/45\n" +
